...
//   const { data: filteredCountries, isLoading } = useGetCountriesNamesQuery(choosenLetter); // отфильтрованные страны по выбранной букве

//   return (
//     <div className="country-sorting">
//       <div className="country-sorting-wrapper">
...
//                   <ul className="country-sorting__countries-list">
//                     {isLoading && <div>Loading...</div>}
//                     {filteredCountries?.map((country: Country) => (
//                       <li className="country-sorting__countries-item" key={country.name}>
//                         {country.name}
//                       </li>
//                     ))}
//                   </ul>
